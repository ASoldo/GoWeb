...
func TestForm_Valid(t *testing.T) {
	r := httptest.NewRequest("POST", "/whateverest", nil)
	form := New(r.PostForm)
...
func TestForm_Required(t *testing.T) {
	r := httptest.NewRequest("POST", "/whatevereeeeest", nil)
	form := New(r.PostForm)
	...
	r, _ = http.NewRequest("POST", "/whateverester", nil)
...
func TestForm_Has(t *testing.T) {
	r := httptest.NewRequest("POST", "/whatevereeeeester", nil)
	form := New(r.PostForm)
...
func TestForm_MinLength(t *testing.T) {
	r := httptest.NewRequest("POST", "/whateverester", nil)
	form := New(r.PostForm)
